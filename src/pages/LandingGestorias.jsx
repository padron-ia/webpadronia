        ...
        <div className="min-h-screen bg-white">
            ...
            <main>
                <section className="premium-gradient-plum py-40 px-6 sm:px-10 lg:px-16 text-center">
                    <h1 className="text-5xl lg:text-7xl text-ink leading-[0.92]">
                    ...
                    <div className="mt-10 flex flex-col items-center gap-4">
                        <a href="#consultoria" className="premium-button bg-ink text-white px-8 py-4 rounded-full font-bold text-lg">
